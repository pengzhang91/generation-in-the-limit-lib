...
| **#21&nbsp;—&nbsp;On&nbsp;Generation&nbsp;in&nbsp;Metric&nbsp;Spaces** [\[LRT 26\]](https://arxiv.org/abs/2602.07710v1) | [Theorems 3.1, 3.3, 3.5–3.6, 4.1–4.2, 4.4, 4.6–4.7, and 4.10; Corollaries 3.2, 3.4, and 4.3; Example 4.5; and Proposition D.1](GenLimitLean/GenLimit/Paper21_GenerationInMetricSpaces/Results/Overview.lean). The facade distinguishes complete results from corrected or diagnostic forms; Examples 4.8, 4.9, and 4.11 remain incomplete. See the [detailed P21 map](GenLimitLean/PaperMaps/Paper21_GenerationInMetricSpaces.md). |
...
- **#21 — On Generation in Metric Spaces** [\[LRT 26\]](https://arxiv.org/abs/2602.07710v1).
  Jiaxun Li, Vinod Raman, and Ambuj Tewari. arXiv:2602.07710v1, 2026.
  [arXiv v1](https://arxiv.org/abs/2602.07710v1) ·
  [DOI](https://doi.org/10.48550/arXiv.2602.07710).
