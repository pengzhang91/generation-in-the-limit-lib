...
| **#17&nbsp;—&nbsp;Infinite&nbsp;Contamination** [\[MVYZ 25\]](https://arxiv.org/abs/2511.07417v1) | **Substantially complete through Theorem 7.8.** The [main-results wrapper](GenLimitLean/GenLimit/Paper17_InfiniteContamination/Results/Overview.lean) covers the priority algorithms and density results through Theorems 6.11, 6.15–6.18, and Algorithm 9 / Theorem 7.8. Theorem 6.14 is proved for the justified range `0 < c < 1`; the source's `c = 1` endpoint is not claimed. See the [detailed P17 map](GenLimitLean/PaperMaps/Paper17_InfiniteContamination.md). |
