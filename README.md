...
| **#07&nbsp;—&nbsp;Density&nbsp;Measures&nbsp;for&nbsp;Language&nbsp;Generation** [\[KW 25\]](https://arxiv.org/abs/2504.14370v1) | The strict-critical selector in [Theorems 3.1/2.1](GenLimitLean/GenLimit/Paper07_DensityMeasuresForLanguageGeneration/InfinitelyOften.lean#L216) and its temporal [Corollary 2.2](GenLimitLean/GenLimit/Paper07_DensityMeasuresForLanguageGeneration/IndexLimsup.lean#L64); [Definition 4.4 and Claims 4.2--4.7](GenLimitLean/GenLimit/Paper07_DensityMeasuresForLanguageGeneration/Feasible.lean); [Claim 6.1](GenLimitLean/GenLimit/Paper07_DensityMeasuresForLanguageGeneration/Topology.lean#L36), [Claims 6.3--6.4](GenLimitLean/GenLimit/Paper07_DensityMeasuresForLanguageGeneration/Levels.lean), and corrected [Claim 6.6](GenLimitLean/GenLimit/Paper07_DensityMeasuresForLanguageGeneration/TowerStart.lean#L53); and Definition 4.5's predicate with conditional uniqueness. The headline density-generation bound is not claimed. |
...
| **#15&nbsp;—&nbsp;Language&nbsp;Generation&nbsp;and&nbsp;Identification&nbsp;From&nbsp;Partial&nbsp;Enumeration** [\[KW 26\]](https://arxiv.org/abs/2511.05295v1) | A semantic finite-scope witness for [Theorem 2.1/Overview Theorem 1.5](GenLimitLean/GenLimit/Paper15_PartialEnumeration/FiniteScope.lean#L154), the semi-index conclusion of [Overview Theorem 1.7](GenLimitLean/GenLimit/Paper15_PartialEnumeration/SemiIndex.lean#L58), and the corrected full-enumeration [Theorem 4.9](GenLimitLean/GenLimit/Paper15_PartialEnumeration/FullTopology.lean#L119) and [Corollary 4.11](GenLimitLean/GenLimit/Paper15_PartialEnumeration/FullTopology.lean#L142) topological cores. No density bound or executable algorithm is claimed. |
| **#23&nbsp;—&nbsp;Validity,&nbsp;Sparse&nbsp;Holes,&nbsp;and&nbsp;Breadth&nbsp;in&nbsp;Language&nbsp;Generation:&nbsp;Banach&nbsp;Density,&nbsp;Topology,&nbsp;and&nbsp;Geometry** [\[KW 26b\]](https://arxiv.org/abs/2604.02385v2) | The absolute one-dimensional lower-Banach and window-density preliminaries in [Claims 3.3 and 3.5](GenLimitLean/GenLimit/Paper23_BanachDensityTopologyAndGeometry/WindowDensity.lean); the Section 3.3 perfect-tower [Claim 3.6](GenLimitLean/GenLimit/Paper23_BanachDensityTopologyAndGeometry/Topology.lean#L57) and finite-natural derivative fragment; and [Claim 4.4/Appendix Claim 7.1](GenLimitLean/GenLimit/Paper23_BanachDensityTopologyAndGeometry/Nice.lean#L75). Relative density, online generation, ordinal ranks, and higher dimensions are outside this slice. |
...
- **#15 — Language Generation and Identification From Partial Enumeration: Tight Density Bounds and Topological Characterizations** [\[KW 26\]](https://arxiv.org/abs/2511.05295).
  Jon Kleinberg and Fan Wei. *Proceedings of the 58th Annual ACM Symposium on
  Theory of Computing (STOC 2026)*, 2026.
  [arXiv](https://arxiv.org/abs/2511.05295) ·
  [STOC accepted paper](https://acm-stoc.org/stoc2026/accepted-papers.html).

- **#23 — Validity, Sparse Holes, and Breadth in Language Generation: Banach Density, Topology, and Geometry** [\[KW 26b\]](https://arxiv.org/abs/2604.02385v2).
  Jon Kleinberg and Fan Wei. arXiv:2604.02385v2, 2026.
