...
| **#17&nbsp;—&nbsp;Infinite&nbsp;Contamination** [\[MVYZ 25\]](https://arxiv.org/abs/2511.07417v1) | **Partial formalization.** The [main-results wrapper](GenLimitLean/GenLimit/Paper17_InfiniteContamination/Results/Overview.lean) covers Examples 3.3–3.4, Lemma 4.1 / Corollary 4.2, explicit-enumeration forms of Theorems 5.1, 5.4, 6.1, the arbitrary-constant Theorem 6.4 obstruction, and the complete Theorem 6.5 characterization, plus Proposition 7.4 / Lemma 7.5. Theorems 6.11 and 6.14–6.18 and Algorithm 9 / Theorem 7.8 remain open; see the [detailed P17 map](GenLimitLean/PaperMaps/Paper17_InfiniteContamination.md). |
