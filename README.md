...
| **#18&nbsp;—&nbsp;Safe&nbsp;Language&nbsp;Generation** [\[AAK 26\]](https://arxiv.org/abs/2601.08648v2) | Qualified semantic [Theorems 3.1, 5.1, and 6.1–6.3](GenLimitLean/GenLimit/Paper18_SafeLanguageGeneration/Results/Overview.lean). Theorems 3.1, 5.1, and 6.2 use documented source repairs; Theorem 6.1 is full for the explicit conventional representation by pairs of total Boolean program codes; and the printed Corollary 6.1 remains open because its reduction collapses under Definition 2. See the [detailed P18 map](GenLimitLean/PaperMaps/Paper18_SafeLanguageGeneration.md). |
