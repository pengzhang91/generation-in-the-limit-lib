...
| **#39&nbsp;—&nbsp;Dense&nbsp;Generation** [\[CLSWZ 26\]](https://arxiv.org/abs/2608.01320v1) | The [arXiv-v1 layer](GenLimitLean/GenLimit/Paper39_DenseGeneration/ArxivV1.lean) reuses #01's direct `Critical` definition and kernel-checks that the highest critical focus can change inside a fixed scope while the old focus survives. This blocks a mechanical transfer of the existing invariant. The full [patient-scope proof](GenLimitLean/GenLimit/Paper39_DenseGeneration/Patient/Main.lean#L36) remains explicitly tied to [recursive criticality from the earlier manuscript](GenLimitLean/GenLimit/Paper39_DenseGeneration/Critical.lean#L19); it is not relabeled as public-v1 Theorem 3.14. Randomized and multi-order sections are not formalized. |
