...
| #17 Infinite Contamination | `GenLimit.InfiniteContamination.theorem_5_1_algorithmFour`, `theorem_5_4_characterization_enumerated`, `theorem_6_1_algorithmFive`, `theorem_6_5_lowerDensity_characterization_enumerated`, `lemma_7_5_change_of_density` | Explicit-family priority generation, complete finite-contamination set-density characterization, and bounded-displacement density; later infinite-noise and element-density results remain open |
