...
/-!
# #0 Language Identification to #01 Language Generation

This bridge keeps the two success criteria distinct:

* #0 identification stabilizes to one exact name of the target language.
* #01 generation eventually outputs target elements fresh from the positive
...
a converse separation using #0's finite-tell-tale obstruction.
-/
