import GenLimit.HallucinationDetection.Appendix
import GenLimit.LiRamanTewari.NonuniformCharacterization

/-!
# Li--Raman--Tewari to hallucination detection

Theorem A.2 of Karbasi--Montasser--Sous--Velegkas invokes the countable-class
generation result formalized in the Li--Raman--Tewari development. Keeping
