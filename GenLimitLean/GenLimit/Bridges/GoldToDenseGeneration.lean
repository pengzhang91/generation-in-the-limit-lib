...
/-!
# Gold identification and dense generation

This semantic bridge instantiates the deterministic patient-scope theorem on
the co-singleton family used for the Gold--KM separation.  Thus the same
...
/-- Patient Scope gives both DenseGeneration-style novelty and its target-
...
/-- Same-family separation strengthened from KM freshness to deterministic
