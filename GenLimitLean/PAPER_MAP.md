...
| **#03 On the Limits of Language Generation** | Probability-free semantic support-oracle cores of online Theorems 3.5, 3.7, and 3.9; qualitative ingredients for Theorems 3.1, 3.2, and 3.13 and Propositions 3.11--3.12 | `GenLimit.Paper03_HallucinationAndModeCollapse` | [#03 map](PaperMaps/Paper03_HallucinationAndModeCollapse.md) | Complete for the listed semantic online cores; statistical rates, randomized/Turing-machine claims, and Appendices A/B are excluded or partial |
