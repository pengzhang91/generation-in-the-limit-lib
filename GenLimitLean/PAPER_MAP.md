...
GenLimit/Paper39_DenseGeneration/           #39 arXiv-v1 diagnostic and earlier patient-scope results
...
| **#39 Dense Generation** | Public arXiv-v1 Definitions 3.2 and 3.5--3.6 via shared KM criticality, with a kernel-checked focus-refresh obstruction; preserved earlier-manuscript patient-scope Lemma 3.11 and Theorem 3.14; earlier partial-enumeration Example 3.15, Lemma 3.16, and Theorem 3.17 | `GenLimit.Paper39_DenseGeneration` | [#39 map](PaperMaps/Paper39_DenseGeneration.md) | Mixed: the arXiv-v1 criticality/focus layer and obstruction are formalized, while the density theorem paths remain explicitly tied to recursive criticality from the earlier manuscript; arXiv-v1 randomized and multi-order sections are excluded |
