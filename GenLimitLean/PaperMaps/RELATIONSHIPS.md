...
| Finite violation counts, bounded set differences, and occurrence/value-contaminated presentations | `GenLimit.Core.FiniteContamination` | Shared noise/corruption vocabulary for #06, #12, and #28; occurrence counts and distinct-value counts remain separate and are proved equivalent for injective streams |
