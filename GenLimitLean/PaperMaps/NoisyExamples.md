# Paper 06 — Raman--Raman paper map

Lean umbrella: `GenLimit.NoisyExamples`
...
`GenLimit.Generic` Core API. Appendix B's recalled Li--Raman--Tewari theorems
remain mapped to the LRT development rather than being duplicated; the
Paper 06 implementation itself does not import the LRT paper layer.
...
The immutable evidence records the audited input snapshot's numbered Paper 06
paths and its then-current LRT aliases.
For this public paper-by-paper integration, those declarations were restored
under `GenLimit.NoisyExamples`, while paper-independent generation, closure,
...
[`record.json`](../AuditRecords/RamanRaman/record.json).
...
| Theorem B.2 | `GenLimit.LiRamanTewari.uniform_generatability_iff_finite_closure_dimension` | Recalled LRT Theorem 3.3, available in the separate LRT development and not imported by Paper 06. |
| Theorem B.3 | `GenLimit.LiRamanTewari.nonuniform_generatability_iff_nondecreasing_finite_closure_cover` | Recalled LRT Theorem 3.5, available separately and not imported by Paper 06. |
| Theorem B.4 | `GenLimit.LiRamanTewari.finite_closure_dimension_cover_implies_generatable_in_limit` | Recalled LRT Theorem 3.10, available separately and not imported by Paper 06. |
...
```text
GenLimit.NoisyExamples.UniformIndependent
GenLimit.NoisyExamples.NoisyClosure
GenLimit.NoisyExamples.NonuniformDefinitions
GenLimit.NoisyExamples.FiniteClasses
GenLimit.NoisyExamples.Nonuniform
GenLimit.NoisyExamples.NoiselessRobustification
GenLimit.NoisyExamples.FiniteUnionLimit
GenLimit.NoisyExamples.Separation
GenLimit.NoisyExamples.AlternatePositive
GenLimit.NoisyExamples.NonuniformIndependent
```

Focused verification:

- `lake build GenLimit.NoisyExamples` checks the paper-facing umbrella.
